    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[("test", "Test"), ("prod", "Production")], max_length=10
            ),
        ),
        migrations.AlterField(
            model_name="project",
        ...
        migrations.AddIndex(
            model_name="projectruleset",
            index=models.Index(
                fields=["default_environment", "default_product"],
                name="idx_rules_env_prod",
            ),
        ),
        migrations.AddIndex(
            model_name="projectruleset",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["tags"], name="idx_rules_tags_gin"
            ),
        ),
