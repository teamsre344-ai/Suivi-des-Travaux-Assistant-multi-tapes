...
class Command(BaseCommand):
    help = "Create 100 more mock projects with random data."

    def handle(self, *args, **kwargs):
        self.stdout.write("Seeding 100 more mock projects…")
        ...
        # Get the last project number to continue the sequence
        ...
        for i in range(1, 101):
            ...
            # Prioritize "Migration" and "Mise a niveau"
            if i <= 80:
                work_type = choice(["Migration", "Mise a niveau"])
            else:
